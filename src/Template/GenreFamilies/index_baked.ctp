 ...
 * @var \App\Model\Entity\GenreFamily[]|\Cake\Collection\CollectionInterface $genreFamilies
 */
?>
...
<div class="genreFamilies index large-9 medium-8 columns content">
    <h3><?= __('Genre Families') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $genreFamily->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $genreFamily->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $genreFamily->id], ['confirm' => __('Are you sure you want to delete # {0}?', $genreFamily->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
